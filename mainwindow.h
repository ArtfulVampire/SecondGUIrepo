...
public:
    ...
    double filesCrossClassification(QString workPath, QString fileName1, QString fileName2, QString cfgFileName = "16sec19ch", int NumOfRepeats = 50, double startCoeff = 10., bool windows = false, int wndLen = 1000, int tShift = 125);
    ...
    double filesAddComponents(QString workPath, QString fileName1, QString fileName2, int NumOfRepeats = 50, bool windows = false, int wndLen = 1000, int tShift = 125);
